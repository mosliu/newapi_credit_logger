    ...
    return SourceResponse.model_validate(
        {
            ...
            "latest_success": entity.latest_success,
            "latest_limit_amount": entity.latest_limit_amount,
            "latest_usage_amount": entity.latest_usage_amount,
            "latest_balance": entity.latest_balance,
            "latest_currency": entity.latest_currency,
            "latest_checked_at": entity.latest_checked_at,
            "latest_http_status": entity.latest_http_status,
            "latest_latency_ms": entity.latest_latency_ms,
            "latest_error_message": entity.latest_error_message,
